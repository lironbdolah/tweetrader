    ...
    for k in keywords:
        for d1, d2 in zip(dates1, dates2):
                ...
                try:
                    ...
                    tweet_count_df = pd.DataFrame(tweets_list, columns=['date', 'tweet_count'])
                    words = k.split(' ')
                    tweets_df.to_csv('C:/Users/bdola/OneDrive/Documents/Order/At/nlp/' + words[0] + '_' + str(stop_count) +str(d1)+'.csv', index=False)
                    tweet_count_df.to_csv('C:/Users/bdola/OneDrive/Documents/Order/At/nlp/' + words[0] + '_' + str(
        ...
        tweet_count_df = pd.DataFrame(tweets_list, columns=['date', 'tweet_count'])
        words = k.split(' ')
        tweets_df.to_csv('C:/Users/bdola/OneDrive/Documents/Order/At/nlp/' + words[0] + '_cos_last.csv',index=False)
        tweet_count_df.to_csv('C:/Users/bdola/OneDrive/Documents/Order/At/nlp/' + words[0] + '_tweet_count.csv', index=False)
        print("file saved")
...
if __name__ == '__main__':
    dates = date_range(date(2019, 1, 1),date(2021, 1, 1))
